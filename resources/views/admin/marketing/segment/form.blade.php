                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" class="form-control" placeholder="{{ __('app.general.description') }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <h5><b>{{ __('app.segment.select-note') }}</b>
                                            <span><span id="contact_count">0</span>{{ __('app.segment.default-note') }}</span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
