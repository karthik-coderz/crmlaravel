        ...
        <div class="page-inner mt--5">
                ...
                <div class="col-md-6">
                    <div class="card full-height">
                        <div class="card-body">
                            ...
                            <div class="card-category">This Month statistics in system</div>
                ...
                <div class="col-md-3">
                    <div class="card card-dark bg-primary-gradient">
                        <div class="card-body pb-0">
                            ...
                            <h2 class="mb-2">17</h2>
                            <p>{{ __('app.contacts.organizations.title') }}</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">{{ __('app.dashboard.emails') }}</div>
                        </div>
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <!-- <div class="avatar">
